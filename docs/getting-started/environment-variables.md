...
| Variable | Description | Default |
|----------|-------------|---------|
| `MILVUS_TOKEN` | Milvus authentication token. Get [Zilliz Personal API Key](https://github.com/danielbowne/claude-context/blob/master/assets/signup_and_get_apikey.png) | Recommended |
